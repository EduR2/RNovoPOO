...
public class FiccaoController {
	...
	class listener implements MouseListener {
		public void mouseClicked(MouseEvent e) {
			try {
				String caminhoArq = "C:\\Users\\pwneg\\OneDrive\\Área de Trabalho\\MVC\\ProjetoNovo6\\Livros\\A Odisseia Estelar.pdf";
	...
	class listener2 implements MouseListener {
		...
		public void mouseClicked(MouseEvent e) {
			try {
				String caminhoArq = "C:\\Users\\pwneg\\OneDrive\\Área de Trabalho\\MVC\\ProjetoNovo6\\Livros\\A Realidade Virtual.pdf";
				if (Desktop.isDesktopSupported()) {
					Desktop desktop = Desktop.getDesktop();
					File file = new File(caminhoArq);
					if (file.exists()) {
	...
	class listener3 implements MouseListener {
		...
		public void mouseClicked(MouseEvent e) {
			try {
				String caminhoArq = "C:\\Users\\pwneg\\OneDrive\\Área de Trabalho\\MVC\\ProjetoNovo6\\Livros\\A Cidade Submersa.pdf";
				if (Desktop.isDesktopSupported()) {
					Desktop desktop = Desktop.getDesktop();
					File file = new File(caminhoArq);
					if (file.exists()) {
