...
public class ManualTelaPrincipalView extends JFrame {
	...
	public void inicializaComponentes() {
		...
		lblNewLabel_1.setBounds(679, 10, 261, 90);
		getContentPane().add(lblNewLabel_1);
		
		l1 = new JLabel(new ImageIcon("C:\\\\Users\\\\eduar\\\\OneDrive\\\\Área de Trabalho\\\\ImagensProjeto\\\\loupe-et-icone-de-recherche-de-c.png"));
		l1.setBounds(509, 122, 90, 90);
		getContentPane().add(l1);
		
		JLabel l1_1 = new JLabel(new ImageIcon("C:\\\\Users\\\\eduar\\\\OneDrive\\\\Área de Trabalho\\\\ImagensProjeto\\\\LogoJO.png"));
		l1_1.setBounds(102, 267, 234, 213);
		getContentPane().add(l1_1);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("C:\\\\Users\\\\eduar\\\\OneDrive\\\\Área de Trabalho\\\\ImagensProjeto\\\\principmanual.png"));
		lblNewLabel.setBounds(249, 122, 983, 577);
