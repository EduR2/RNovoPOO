...
public class GenerosView extends JFrame {
	...
	public void inicializarComponentes() {
		...
		l1.setIcon(new ImageIcon("C:\\\\Users\\\\eduar\\\\OneDrive\\\\Área de Trabalho\\\\ImagensProjeto\\\\acao.png"));
		l1.setBounds(21, 10, 218, 205);
		getContentPane().add(l1);

		JLabel l2 = new JLabel("New label");
		l2.setIcon(
				new ImageIcon("C:\\\\Users\\\\eduar\\\\OneDrive\\\\Área de Trabalho\\\\ImagensProjeto\\\\Terror.png"));
		l2.setBounds(259, 10, 233, 205);
		getContentPane().add(l2);

		JLabel l3 = new JLabel("New label");
		l3.setIcon(
				new ImageIcon("C:\\\\Users\\\\eduar\\\\OneDrive\\\\Área de Trabalho\\\\ImagensProjeto\\\\Ficção.png"));
		l3.setBounds(502, 10, 233, 205);
		getContentPane().add(l3);

		JLabel l4 = new JLabel("New label");
		l4.setIcon(
				new ImageIcon("C:\\\\Users\\\\eduar\\\\OneDrive\\\\Área de Trabalho\\\\ImagensProjeto\\\\Romance.png"));
		...
		sair.setIcon(
				new ImageIcon("C:\\\\Users\\\\eduar\\\\OneDrive\\\\Área de Trabalho\\\\ImagensProjeto\\\\Sair.png"));
