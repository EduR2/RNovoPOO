...
public class ManuaUserView extends JFrame {
	...
	public void inicializaComponentes() {
		...
		panel_1.setBounds(-20, 89, 1550, 2);
		getContentPane().add(panel_1);
		
		JLabel UsodasTelasdeTexto = new JLabel("leitura e execução de resumos");
		UsodasTelasdeTexto.setHorizontalAlignment(SwingConstants.TRAILING);
		UsodasTelasdeTexto.setFont(new Font("Franklin Gothic Heavy", Font.PLAIN, 13));
		UsodasTelasdeTexto.setIcon(new ImageIcon("C:\\Users\\eduar\\OneDrive\\Área de Trabalho\\ProjetoREAD7NOVO\\ProjetoREAD7\\Imagens\\usual2.png"));
		UsodasTelasdeTexto.setBounds(339, 138, 311, 81);
		getContentPane().add(UsodasTelasdeTexto);
		
		JLabel lblNewLabel_2 = new JLabel("Controle do Manual");
		lblNewLabel_2.setFont(new Font("Segoe UI Variable", Font.PLAIN, 21));
		lblNewLabel_2.setBounds(299, 24, 213, 42);
		getContentPane().add(lblNewLabel_2);
		
		JLabel lblNewLabel_1 = new JLabel("Tela Principal");
		lblNewLabel_1.setFont(new Font("Franklin Gothic Heavy", Font.PLAIN, 13));
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\eduar\\OneDrive\\Área de Trabalho\\ProjetoREAD7NOVO\\ProjetoREAD7\\Imagens\\princip2.png"));
		lblNewLabel_1.setBounds(57, 123, 168, 102);
		getContentPane().add(lblNewLabel_1);
		
		JLabel imagemLabel = new JLabel("C:\\Users\\eduar\\OneDrive\\Imagens\\Capturas de tela.png");
		UsodasTelasdeTexto.addMouseListener(new MouseListener() {
