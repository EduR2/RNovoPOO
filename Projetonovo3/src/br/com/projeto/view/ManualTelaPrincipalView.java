...
public class ManualTelaPrincipalView extends JFrame {
	...
	public void inicializaComponentes() {
		...
		JLabel l1_1 = new JLabel(new ImageIcon("C:\\Users\\eduar"
				+ "\\OneDrive\\Área de Trabalho\\MVC\\Projetonovo2\\Imagens\\LogoJO.png"));
		l1_1.setBounds(102, 267, 234, 213);
		getContentPane().add(l1_1);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\pwneg\\OneDrive\\Área de Trabalho\\MVC\\Projetonovo3\\Imagens\\principmanual.png"));
